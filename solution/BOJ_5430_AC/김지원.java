...
public class Main {
    ...
    public static void AC(String command, ArrayDeque<Integer> deque) { //계산하는 함수
    ...
    public static void makePrintString(ArrayDeque<Integer> deque, boolean isRight) { //프린트 할 문장 만드는 함수
